// based on https://coinbase.com/assets/button.js
((function () {
	var a;
	function dataGetter(obj) {
		if (obj.code) {
			return {data: function (key) {
	...
	a = function (a, b, c, d) {
		...
		}, coinbaseShowModal = window.coinbaseShowModal = function (c) {
		...
		}, coinbaseButtonify = window.coinbaseButtonify = function (e) {
			var g, h, i, j, k, l;
			return g = dataGetter(e), i = g.data(), i.referrer = document.domain, k = a.param(i), h = g.data("code"), l = g.data("width") || c(g.data("button-style")), j = g.data("height") || 46, f(g.data("env")), a("body").append("<iframe src='" + d + "/buttons/" + h + "/widget?" + k + "' id='coinbase_modal_iframe_" + h + "' name='coinbase_modal_iframe_" + h + "' style='background-color: transparent; border: 0px none transparent; overflow: hidden; display: none; position: fixed; visibility: visible; margin: 0px; padding: 0px; left: 0px; top: 0px; width: 100%; height: 100%; z-index: 9999;' scrolling='no' allowtransparency='true' frameborder='0'></iframe>")
